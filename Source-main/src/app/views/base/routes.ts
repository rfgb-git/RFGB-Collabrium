...
export const routes: Routes = [
  {
    ...
    children: [
      ...
      {
        path: 'asn',
        loadComponent: () => import('./asn/asn.component').then(m => m.AsnComponent),
        data: {
          title: 'ASN'
        }
      },
      {
        path: 'asn-request',
        loadComponent: () => import('./asn-request/asn-request.component').then(m => m.AsnRequestComponent),
        data: {
          title: 'ASN-Request'
        }
      },
      {
        path: 'asn-report',
        loadComponent: () => import('./asn-report/asn-report.component').then(m => m.AsnReportComponent),
        data: {
          title: 'ASN-Report'
        }
      },
      {
        path: 'asn-approval',
        loadComponent: () => import('./asn-approval/asn-approval.component').then(m => m.AsnApprovalComponent),
        data: {
          title: 'ASN-Approval'
        }
      },
