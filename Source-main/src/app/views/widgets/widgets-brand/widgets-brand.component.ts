  ...
  brandData: BrandData[] = [
    {
      icon: 'cilNotes',
      // title: 'Pending',
      values: [{ title: 'Open', value: '60K' }, { title: 'Close', value: '459K' }],
      capBg: { '--cui-card-cap-bg': '#8cc63c' },
      labels: [...this.labels],
      data: {
        labels: [...this.labels],
        datasets: [{ ...this.datasets, data: [65, 59, 84, 84, 51, 55, 40], label: 'PO', ...this.colors }]
      }
    },
    {
      icon: 'cilLocationPin',
      values: [{ title: 'Open', value: '973k' }, { title: 'Close', value: '1.792' }],
      capBg: { '--cui-card-cap-bg': '#00aced' },
      data: {
        labels: [...this.labels],
        datasets: [{ ...this.datasets, data: [1, 13, 9, 17, 34, 41, 38], label: 'Delivery Status', ...this.colors }]
      }
    },
    {
      icon: 'cilIndentIncrease',
      values: [{ title: 'Open', value: '500' }, { title: 'Close', value: '1.292' }],
      capBg: { '--cui-card-cap-bg': '#4875b4' },
      data: {
        labels: [...this.labels],
        datasets: [{ ...this.datasets, data: [78, 81, 80, 45, 34, 12, 40], label: 'ASN', ...this.colors }]
      }
    },
    {
      icon: 'cilMenu',
      values: [{ title: 'Open', value: '12+' }, { title: 'Close', value: '4' }],
      capBg: { '--cui-card-cap-bg': 'var(--cui-warning)' },
      data: {
        labels: [...this.labels],
        datasets: [{ ...this.datasets, data: [35, 23, 56, 22, 97, 23, 64], label: 'Schedule', ...this.colors }]
      }
    }
  ];
